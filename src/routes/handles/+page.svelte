...
<main>
    ...
    <div class="form grid justify-items-center">
        <form method="POST" action="/success" class="grid" on:enhance>
            ...
            <input type="submit"  on:submit={()=>{alert("The message is sent ! ")}} value="submit" class="bg-amber-300 mx-auto px-4 border-2 border-amber-700 mt-4 mb-8">
        </form>
    </div>
